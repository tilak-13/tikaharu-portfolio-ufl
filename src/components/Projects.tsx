        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              <div
                key={index}
                className="gradient-card rounded-2xl overflow-hidden shadow-elegant hover:shadow-hover transition-smooth group"
              >
                {/* Project header with gradient */}
                <div className={`h-2 bg-gradient-to-r ${project.gradient}`}></div>
                
                <div className="p-8">
                  <h3 className="text-2xl font-semibold text-foreground mb-4 group-hover:text-accent transition-smooth">
                    {project.title}
                  </h3>
